    ...
    cabinet = Cabinet(
        ...
        components=[
            ...
            CabinetComponent(
                ...
                length=864.0, width=595.0, height=18.0,
                position=Vector3(x=18, y=400, z=5),
                material="plywood", color="#F5E6D3", thickness=18.0,
            ),
            CabinetComponent(
                ...
                children=[
                    CabinetComponent(
                        ...
                        position=Vector3(x=824, y=152.8, z=18),
    ...
    cabinet = Cabinet(
        ...
        components=[
            ...
            CabinetComponent(
                ...
                length=18.0, width=595.0, height=2164.0,
                position=Vector3(x=891, y=18, z=5),
                material="plywood", color="#E8D5C4", thickness=18.0,
            ),
            CabinetComponent(
                id="shelf_left_upper", name="左上层板", type=ComponentType.SHELF,
                length=873.0, width=595.0, height=18.0,
                position=Vector3(x=18, y=1800, z=5),
                material="plywood", color="#E8D5C4", thickness=18.0,
            ),
            CabinetComponent(
                id="shelf_right_upper", name="右上层板", type=ComponentType.SHELF,
                length=873.0, width=595.0, height=18.0,
                position=Vector3(x=909, y=1800, z=5),
                material="plywood", color="#E8D5C4", thickness=18.0,
            ),
            CabinetComponent(
            ...
            CabinetComponent(
                ...
                length=873.0, width=595.0, height=18.0,
                position=Vector3(x=909, y=400, z=5),
                material="plywood", color="#E8D5C4", thickness=18.0,
            ),
            CabinetComponent(
            ...
            CabinetComponent(
                ...
                position=Vector3(x=18, y=418, z=600),
                material="plywood", color="#FFF5EB", thickness=18.0,
                children=[
                    CabinetComponent(
                        ...
                        children=[
                            CabinetComponent(
                                ...
                                position=Vector3(x=842, y=352.8, z=18),
                                material="metal", color="#C0C0C0",
                            ),
                        ],
                    ),
                    CabinetComponent(
                        ...
                        children=[
                            CabinetComponent(
                                ...
                                length=20.0, width=30.0, height=1058.4,
                                position=Vector3(x=20, y=352.8, z=18),
                                material="metal", color="#C0C0C0",
                            ),
                        ],
                    ),
    ...
    cabinet = Cabinet(
        ...
        components=[
            ...
            CabinetComponent(
                ...
                length=1164.0, width=395.0, height=18.0,
                position=Vector3(x=18, y=360, z=5),
                material="plywood", color="#D2B48C", thickness=18.0,
            ),
            CabinetComponent(
                id="shelf_2", name="层板2", type=ComponentType.SHELF,
                length=1164.0, width=395.0, height=18.0,
                position=Vector3(x=18, y=720, z=5),
                material="plywood", color="#D2B48C", thickness=18.0,
            ),
            CabinetComponent(
                id="shelf_3", name="层板3", type=ComponentType.SHELF,
                length=1164.0, width=395.0, height=18.0,
                position=Vector3(x=18, y=1080, z=5),
                material="plywood", color="#D2B48C", thickness=18.0,
            ),
            CabinetComponent(
                id="shelf_4", name="层板4", type=ComponentType.SHELF,
                length=1164.0, width=395.0, height=18.0,
                position=Vector3(x=18, y=1440, z=5),
                material="plywood", color="#D2B48C", thickness=18.0,
            ),
        ],
    )
